import globalList from "./mock_data/global_list.json";
import vsCard from "./mock_data/vs_card_01.json";
import localList from "./mock_data/local_list.json";
...
export async function readGlobalList() {
  const data = globalList as GlobalListResponse;
