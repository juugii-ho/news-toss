...
def generate_thumbnail_prompt(topic, article_map):
    ...
    final_prompt = f"{country}의 '{topic_name}' 주제로 {sentence} 내용이 담긴 언론사진 느낌의 한국어 썸네일. **주의사항** : 1.마침표 사용 금지, 2.하단에 'AI로 생성된 이미지'라는 문구 삽입 3. 같은 문장 재사용 금지"
...
def main():
    print("🚀 Starting Thumbnail Generator (GitHub Actions Mode)...")
